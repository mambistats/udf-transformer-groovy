...
package com.kc14.janvanbesien.com.googlecode.ipv6;

import static com.kc14.janvanbesien.com.googlecode.ipv6.IPv6AddressHelpers.prefixWithZeroBytes;
...
public final class IPv6Address implements Countable<IPv6Address>, Serializable
{
    ...
    {
        int byte0 = (int) ((this.lowBits & 0x00000000FF000000L) >> 24);
        int byte1 = (int) ((this.lowBits & 0x0000000000FF0000L) >> 16);
        int byte2 = (int) ((this.lowBits & 0x000000000000FF00L) >> 8);
        int byte3 = (int) ((this.lowBits & 0x00000000000000FFL));

        final StringBuilder result = new StringBuilder("::ffff:");
        result.append(byte0).append(".").append(byte1).append(".").append(byte2).append(".").append(byte3);
    ...
    {
        if (isIPv4Mapped())
            return toIPv4AddressString();
        else
            return toShortHandNotationString();
    }

    private String toIPv4AddressString()
    {
        int byte0 = (int) ((this.lowBits & 0x00000000FF000000L) >> 24);
        int byte1 = (int) ((this.lowBits & 0x0000000000FF0000L) >> 16);
        int byte2 = (int) ((this.lowBits & 0x000000000000FF00L) >> 8);
    ...
    public int compareTo(IPv6Address that)
    {
        ...
        // else if (this.highBits == that.highBits) // Can never be true!
        //     return 0;
        else
